...
The Roles section allows for managing user roles within the system.
...
2. Select **View Roles** to open the Roles management page.
...
1. **View Roles**: Displays a list of all roles.
2. **Create Role**: Add new roles with custom permissions.
3. **Update Role**: Modify existing roles.
4. **Delete Role**: Permanently remove roles.
