...
GeneSys Admin implements a role hierarchy to control access to various features and sections of the application. Below is the hierarchical structure of roles:


Roles Hierarchy
===============

The GeneSys Admin application uses a Role-Based Access Control (RBAC) system with the following hierarchy:
